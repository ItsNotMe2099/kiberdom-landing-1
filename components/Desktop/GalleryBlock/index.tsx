...
export default function GalleryBlock(props: Props) {
  ...
  const { isPhoneWidth, isSmDesktopWidth, isLDesktopWidth, isVLDesktopWidth, isVSmDesktopWidth } = useResize()
    ...
    <div className={styles.root}>
      <div className={styles.content}>
        <div className={styles.row}>
          ...
          {!isVSmDesktopWidth && <Image className={styles.second} src={'/img/gallery/2.png'} alt='' fill />}
        </div>
        <div className={styles.row}>
